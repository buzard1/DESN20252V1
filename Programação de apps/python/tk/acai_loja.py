...
class AcaiApp:
    def __init__(self, root):
        ...
        self.root.geometry("400x500")  # Janela maior

        # Adicionando frame e scrollbar
    ...
    def criar_interface(self):
        ...
        tk.Label(self.scrollable_frame, text="Escolha o tamanho do copo:").pack()
        self.criar_radio_buttons_tamanhos()

        tk.Label(self.scrollable_frame, text="Escolha um açaí pré-pronto (Opcional):").pack()
        self.criar_radio_buttons_acais()

        tk.Label(self.scrollable_frame, text="Escolha os acompanhamentos:").pack()
        self.criar_check_buttons_acompanhamentos()

        tk.Label(self.scrollable_frame, text="Forma de pagamento:").pack()
